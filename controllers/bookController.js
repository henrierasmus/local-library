...
exports.book_detail = (req, res, next) => {
    async.parallel({
        ...
        book_instance: function(callback) {
            ...
            // successful, render book detail page            
            res.render('book_detail', { title: result.book.title, book: result.book, book_instance: result.book_instance });
    });
};
...
exports.book_delete_get = (req, res, next) => {
    async.parallel({
        ...
        // Successful, render book delete page
...
exports.book_delete_post = (req, res, next) => {
    async.parallel({
        ...
        if(err) { return next(err) }
        // Book has book instances associated with the object
...
exports.book_update_post = [
    ...
    (req, res, next) => {
        ...
        // Create a Book object with data and old id
        const book = new Book(
            {
                title: req.body.title,
                author: req.body.author,
